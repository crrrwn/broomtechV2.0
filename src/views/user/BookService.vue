          ...
          <div class="px-8 py-10">
            ...
            <form @submit.prevent="validateAndProceed" class="rounded-lg">
              ...
              <div v-if="selectedService.id === 'pay_bills'" class="space-y-6">
                <div class="p-6 rounded-xl mb-8 border-l-4 bg-green-50 border-green-500">
                  <p class="font-medium text-green-800">Please provide details about the bill you want us to pay.</p>
                </div>
                
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                  <div class="col-span-1">
                    <label for="biller" class="block text-sm font-medium mb-1 text-gray-700">
                      Biller / Company Name <span class="text-red-500">*</span>
                    </label>
                    <div class="relative rounded-md shadow-sm">
                      <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        <svg 
                      ...
                      <input 
                        ...
                        maxlength="100"
                        placeholder="e.g., Meralco, Globe, PLDT, etc."
                    ...
                    <p class="mt-1 text-xs text-gray-500" v-else>Enter the biller name (max 100 characters)</p>
                  </div>
                ...
                <div>
                  <label for="bill-details" class="block text-sm font-medium mb-1 text-gray-700">
                    Bill Details <span class="text-red-500">*</span>
                  </label>
                  <div class="relative rounded-md shadow-sm">
                    <div class="absolute top-3 left-3 flex items-start pointer-events-none">
                      <svg 
                    ...
                    <textarea 
                      ...
                      rows="4" 
                      maxlength="500"
                      placeholder="Provide account number, bill amount, due date, and any other relevant information"
                      @blur="validateField('details')"
                    ></textarea>
                    <div class="absolute top-3 right-3 pointer-events-none" v-if="errors.details">
                      <svg class="h-5 w-5 text-red-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                  ...
                  <div class="flex justify-between mt-1">
                    <p class="text-sm text-red-600" v-if="errors.details">{{ errors.details }}</p>
                    <p class="text-xs text-gray-500" v-else>Provide detailed bill information</p>
                    <p class="text-xs text-gray-500">{{ bookingData.details.length }}/500</p>
                  </div>
                </div>
                
                <div>
                  <label for="receipt-address" class="block text-sm font-medium mb-1 text-gray-700">
                    Receipt Delivery Address <span class="text-red-500">*</span>
                  </label>
                  <div class="relative rounded-md shadow-sm">
                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                      <svg 
                    ...
                    <input 
                      ...
                      maxlength="200"
                      placeholder="Enter address where you want the receipt delivered"
                      @blur="validateField('dropLocation')"
                    />
                    <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none" v-if="errors.dropLocation">
                      <svg class="h-5 w-5 text-red-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
              ...
              <!-- Pickup & Drop Form -->
              <div v-if="selectedService.id === 'pickup_drop'" class="space-y-6">
                <div class="p-6 rounded-xl mb-8 border-l-4 bg-green-50 border-green-500">
                  <p class="font-medium text-green-800">Please provide details about the item you want us to pick up and deliver.</p>
                </div>
                
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                  <div class="col-span-1">
                    <label for="pickup-location" class="block text-sm font-medium mb-1 text-gray-700">
                    ...
                    <p class="mt-1 text-sm text-red-600" v-if="errors.pickupLocation">{{ errors.pickupLocation }}</p>
                    <p class="mt-1 text-xs text-gray-500" v-else>Enter a valid pickup location (max 200 characters)</p>
                  </div>
                  
                  <div class="col-span-1">
                    <label for="drop-location" class="block text-sm font-medium mb-1 text-gray-700">
                    ...
                    <p class="mt-1 text-sm text-red-600" v-if="errors.dropLocation">{{ errors.dropLocation }}</p>
                    <p class="mt-1 text-xs text-gray-500" v-else>Enter a valid drop-off location (max 200 characters)</p>
                  </div>
                </div>
                
                <div>
                  <label for="item-details" class="block text-sm font-medium mb-1 text-gray-700">
                    Item Details <span class="text-red-500">*</span>
                  </label>
                  <div class="relative rounded-md shadow-sm">
                    <div class="absolute top-3 left-3 flex items-start pointer-events-none">
                      <svg 
                  ...
                  <div class="flex justify-between mt-1">
                    <p class="text-sm text-red-600" v-if="errors.details">{{ errors.details }}</p>
                    <p class="text-xs text-gray-500" v-else>Provide detailed item information</p>
                    <p class="text-xs text-gray-500">{{ bookingData.details.length }}/500</p>
                  </div>
                </div>
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                  <div class="col-span-1">
                    <label for="recipient-name" class="block text-sm font-medium mb-1 text-gray-700">
                    ...
                    <p class="mt-1 text-xs text-gray-500" v-else>Enter the recipient's full name</p>
                  </div>
                  
                  <div class="col-span-1">
                    <label for="recipient-contact" class="block text-sm font-medium mb-1 text-gray-700">
                      Recipient Contact Number <span class="text-red-500">*</span>
                    </label>
                    <div class="relative rounded-md shadow-sm">
                      <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        <svg 
                    ...
                    <p class="mt-1 text-xs text-gray-500" v-else>Enter a valid Philippine phone number</p>
                  </div>
                </div>
              </div>
              
              <!-- Gifts Delivery Form -->
              <div v-if="selectedService.id === 'gifts_delivery'" class="space-y-6">
                <div class="p-6 rounded-xl mb-8 border-l-4 bg-green-50 border-green-500">
                  <p class="font-medium text-green-800">Please provide details about the gift or surprise you want to deliver.</p>
                </div>
                
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                  <div class="col-span-1">
                    <label for="pickup-location-gift" class="block text-sm font-medium mb-1 text-gray-700">
                      Pickup Location <span class="text-red-500">*</span>
                    </label>
                    <div class="relative rounded-md shadow-sm">
                      <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  ...
                  <div class="col-span-1">
                    <label for="delivery-location-gift" class="block text-sm font-medium mb-1 text-gray-700">
                    ...
                    <p class="mt-1 text-sm text-red-600" v-if="errors.dropLocation">{{ errors.dropLocation }}</p>
                    <p class="mt-1 text-xs text-gray-500" v-else>Enter a valid delivery location (max 200 characters)</p>
                  </div>
                </div>
                
                <div>
                  <label for="gift-details" class="block text-sm font-medium mb-1 text-gray-700">
                    Gift Details <span class="text-red-500">*</span>
                  </label>
                  <div class="relative rounded-md shadow-sm">
                    <div class="absolute top-3 left-3 flex items-start pointer-events-none">
                      <svg 
                    ...
                    <textarea 
                      ...
                      rows="4" 
                      maxlength="500"
                      placeholder="Describe the gift, occasion, and any special delivery instructions or message to be included"
                      @blur="validateField('details')"
                    ></textarea>
                    <div class="absolute top-3 right-3 pointer-events-none" v-if="errors.details">
                      <svg class="h-5 w-5 text-red-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                  ...
                  <div class="flex justify-between mt-1">
                    <p class="text-sm text-red-600" v-if="errors.details">{{ errors.details }}</p>
                    <p class="text-xs text-gray-500" v-else>Provide detailed gift information</p>
                    <p class="text-xs text-gray-500">{{ bookingData.details.length }}/500</p>
                  </div>
                </div>
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                  <div class="col-span-1">
                    <label for="recipient-name-gift" class="block text-sm font-medium mb-1 text-gray-700">
                      Recipient Name <span class="text-red-500">*</span>
                    </label>
                    <div class="relative rounded-md shadow-sm">
                      <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  ...
                  <div class="col-span-1">
                    <label for="recipient-contact-gift" class="block text-sm font-medium mb-1 text-gray-700">
                      Recipient Contact Number <span class="text-red-500">*</span>
                    </label>
                    <div class="relative rounded-md shadow-sm">
                      <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
